...
python train_model_parallel.py --model resnet34 --batch_size 128 --epochs 50
...
python train_single_gpu.py --model resnet34 --batch_size 128 --epochs 50 --gpu 0 --use_cache
...
python train_single_gpu.py --model resnet34 --batch_size 128 --epochs 50 --gpu 0 --amp
